 ...
 * @author Raz
 */
public class InsumosController implements ActionListener {
    ...
    public InsumosController(Insumo producto, InsumosDAO productoConnection, SystemViewResponsive vista) {
